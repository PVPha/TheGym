                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-7">
                                    ...
                                    <a type="button" id="btn-mb" class="btn btn-success" data-toggle="modal" data-target="#addNews"><i
                                ...
                                <div class="col-5 justify-content-end " style="transform: translateX(8rem);">
                                    <form class="form-inline" name="form-SMB">
                                        <div class="form-group">
                                            <label for=""></label>
                                            <input type="text" name="s_mb" id="" class="form-control" placeholder=""
                                                aria-describedby="helpId">
                                        </div>
                                        <button type="submit" class="btn btn-primary" onclick="searchMember(event)">Tìm
                                            kiếm</button>
                                    </form>
                                </div>
                            </div>
